...
function Seekersendmail() {
    ...
    const verifyOtpf = async () => {
        ...
        if (OTP == "") {
            ...
            const resp = await fetch("https://jobshubback-19af.onrender.com/seekerotpverify", config);
    ...
    const changepassword = async () => {
        if (data.newpwd == data.conpwd) {
            ...
            const response = await fetch("https://jobshubback-19af.onrender.com/seekerforgot", config);
